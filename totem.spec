...
export LANG=C
export SOURCE_DATE_EPOCH=1535078085
CFLAGS="$CFLAGS" CXXFLAGS="$CXXFLAGS" LDFLAGS="$LDFLAGS" meson --prefix /usr --buildtype=plain -Denable-vala=no  builddir
ninja -v -C builddir

%install
mkdir -p %{buildroot}/usr/share/doc/totem
cp COPYING %{buildroot}/usr/share/doc/totem/COPYING
cp license_change %{buildroot}/usr/share/doc/totem/license_change
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/totem/COPYING
/usr/share/doc/totem/license_change
